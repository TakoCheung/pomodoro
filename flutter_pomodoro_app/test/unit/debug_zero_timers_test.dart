...
void main() {
  test(
      'LocalSettings.updateDebugMode(true) zero minutes maps to 1 second per timer',
      () {
  ...
  test(
      'TimerNotifier.updateSettings with debug 0 minutes results in 1 second remaining',
      () {
    final container = ProviderContainer();
    addTearDown(container.dispose);

...
void main() {
  group('TimerNotifier targeted tests', () {
    test('progress uses modulo 60 correctly', () {
      ...
      notifier.state = notifier.state.copyWith(timeRemaining: 125); // 5*60 + 5 -> progress 5/60
    ...
    test('updateSettings calls setMode and updates timeRemaining accordingly', () {
      final notifier = TimerNotifier();
      final local = LocalSettings(initPomodoro: 1200, initShortBreak: 300, initLongBreak: 600, fontFamily: 'F', color: Colors.blue);
